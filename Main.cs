...
public class SGD285_1
{
    ...
    public static void Main()
    {
	    ...
	    {
           new UserQuote("Bahram Dahi", "I have never let my schooling interfere with my education. - [attributed to] Mark Twain"), /* by: Kevin Januszewski, I find this quote to be quite funny */
	       new UserQuote("Ryan Douglass", "If there is no struggle there is no progress. - Frederick Douglass"),
	       new UserQuote("Baylen Smith", "Whatever happens, happens. - Spike Spiegel"), /* by: Kevin Januszewski, I find this quote to be matter of fact! */
